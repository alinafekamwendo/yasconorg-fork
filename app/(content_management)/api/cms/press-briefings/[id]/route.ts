...
import { getPressBriefingById, updatePressBriefing, deletePressBriefing } from "@/lib/cms/service";
...
export async function GET(_req: NextRequest, { params }: Ctx) {
  try {
    ...
    const item = await getPressBriefingById(id);
...
export async function PATCH(req: NextRequest, { params }: Ctx) {
  try {
    ...
    const item = await updatePressBriefing(id, {
