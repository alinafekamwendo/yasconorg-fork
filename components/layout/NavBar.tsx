      ...
      sections: [
        {
          ...
          links: [
            ...
            { href: "/enterprises/yascon/livestock-production", label: "Livestock Production" },
            { href: "/enterprises/yascon/crop-production", label: "Crop Production" },
            { href: "/enterprises/yascon/fertilizer", label: "Fertilizer Production" },
            { href: "/enterprises/yascon/retailing", label: "Retailing" },
            { href: "/enterprises/yascon/research", label: "Research" },
            { href: "/enterprises/yascon/project-implmentation", label: "Project Implementation" },
        ...
        },
        {
          ...
          links: [
            { href: "/enterprises/other/other-enterprises", label: "Other Enterprises" },
          ],
        },
      ],
    },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-full flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 shrink-0">
            <div className="relative w-14 h-14">
              <Image src="/Log.png" alt="YASCON Logo" fill className="object-contain rounded-full" />
            </div>
            <div className="hidden sm:block">
              <div className="font-bold tracking-[0.2em] text-sm text-white leading-none">YASCON</div>
            ...
            {navItems.map((item, idx) => (
              ...
              >
                ...
                >
                  ...
                  <span className={`absolute bottom-0 left-3.5 right-3.5 h-[2px] bg-[#f4a32a] transition-all duration-200 origin-left
                ...
                {activeDropdown === idx && (
                  <div
                    ...
                    style={{ left: "50%", transform: "translateX(-50%)", minWidth: "520px" }}
          ...
          <div className="sticky top-0 bg-[#0f1f0f] border-b border-white/10 px-5 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="relative w-10 h-10">
                <Image src="/Log.png" alt="YASCON" fill className="object-contain rounded-full" />
              </div>
              <div>
                <div className="font-bold tracking-widest text-white text-xs">YASCON</div>
                <div className="text-[10px] text-white/40">Conservation & Environment</div>
              </div>
            </div>
            <button
  ...
  return (
    <div className="bg-white shadow-xl border border-gray-100 overflow-hidden">
      ...
      <div className=" px-6 py-3.5 ">
        <p className="text-gray-900 font-bold text-xs tracking-widest uppercase">{dropdown.title}</p>
      </div>

      {/* 2-column grid */}
      <div className={`grid ${dropdown.columns.length === 2 ? "grid-cols-2 divide-x divide-gray-100" : "grid-cols-1"}`}>
      ...
      <div className="bg-gray-50 border-t border-gray-100 px-6 py-2.5 flex items-center justify-between">
        <span className="text-[10px] text-gray-400">YASCON — Conservation & Environment</span>
        <Link href="/contact" className="text-[11px] text-green-700 font-semibold hover:text-green-900 flex items-center gap-1">
          Contact us
  ...
  return (
    <div className="bg-white shadow-xl border border-gray-100 overflow-hidden">
      ...
      <div className=" px-6 py-3.5 flex items-center justify-between border-b border-gray-100">
          ...
          <p className="text-gray-900 font-bold text-xs tracking-widest uppercase mt-0.5">Social enterprises</p>
      ...
      <div className="grid grid-cols-2 divide-x divide-gray-100">
        {dropdown.sections.map((section, si) => (
          <div key={si} className="p-5">
            {/* Section label */}
            <p className={`text-[10px] font-bold uppercase tracking-widest mb-3 pb-2 border-b ${
              si === 0
      ...
      {/* Footer */}
      <div className="bg-gray-50 border-t border-gray-100 px-6 py-2.5 flex items-center justify-between">
        <span className="text-[10px] text-gray-400">Building a sustainable economy for Malawi</span>
